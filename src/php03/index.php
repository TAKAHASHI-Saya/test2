...
<body>
    <header class="header">
        <div class="header_inner">
            <a href="/php03" class="header_logo">Status Code Quiz</a>
        </div>
    </header>
    <main>
            ...
            <form action="result.php" method="post" class="quiz-form">
                ...
                <div class="quiz-form_item">
                    ...
                    <div class="quiz-form_group">
                        <input type="radio" id = "<?php echo $option['code']?>" name = "option" value = "<?php echo $option['code']?>" class="quiz-form_radio">
